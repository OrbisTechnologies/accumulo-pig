...
public class AccumuloWholeRowStorage extends AbstractAccumuloStorage {
  ...
  private static final Log LOG = LogFactory
          .getLog(AccumuloWholeRowStorage.class);
  ...
  private Tuple columnToTuple(Text colfam, Text colqual, Text colvis, long ts,
                              Value val) throws IOException {
  ...
  protected void configureInputFormat(Job job) {
    CloudbaseInputFormat.setIterator(job, 10,
