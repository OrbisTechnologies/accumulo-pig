...
public class Bytes {
     ...
     * @return Runs {@link WritableComparator#hashBytes(byte[], int)} on the passed in array. This method is what
     ...
     * @return Runs {@link WritableComparator#hashBytes(byte[], int)} on the passed in array. This method is what
     * {@link org.apache.hadoop.io.Text} and use calculating hash code.
     */
     ...
     *
     * @param value - array of bytes containing long (length <= SIZEOF_LONG) @param am ount value will be incremented on
     * (deincremented if negative) @return array of bytes containing incremented long (length == SIZEOF_LONG) @thr o ws
